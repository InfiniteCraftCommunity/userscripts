...
(function () {
  window.addEventListener('load', async () => {
    ...
    unsafeWindow.$nuxt.$root.$children[1].$children[0].$children[0].sorts.push("length");
    let elementals = null;
    ...
    unsafeWindow.$nuxt.$root.$children[1].$children[0].$children[0]._computedWatchers.sortedElements.getter =
      exportFunction(() => {
        if (unsafeWindow.$nuxt.$root.$children[1].$children[0].$children[0]._data.sortBy === "length") {
