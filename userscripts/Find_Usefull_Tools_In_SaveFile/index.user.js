...
(function(){
  ...
  let regexes=['^[^a-zA-Z0-9][a-zA-Z][^a-zA-Z0-9]{0,1}$','^string.append\([^a-zA-Z0-9][a-zA-Z0-9][^a-zA-Z0-9]\)$','^mr','^u[\+]+[a-zA-Z0-9]+$',"^u[\+][a-zA-Z0-9]{4}$",'^[^a-zA-Z]{0,1}the',
  '^with\s','^without\s','^dr[^a-zA-Z0-9]','^add+'
  ]
   function getSave() {
