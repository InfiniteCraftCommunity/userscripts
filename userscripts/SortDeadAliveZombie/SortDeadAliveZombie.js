...
(function () {
  ...
  function makeLoadModal(close = false) {
    ...
    if (loadModal == null) {//  console.log("first making");
    ...
    if (close == false) {      //  console.log("open");
  ...
  function removeElementZombie(element, takeText = function (e) { return e.text; }) {
    ...
    if (localStorage.getItem("zombies")) {
      ...
      if (zombies.includes(takeText(element))) { // console.log("zombie?",takeText(element));
