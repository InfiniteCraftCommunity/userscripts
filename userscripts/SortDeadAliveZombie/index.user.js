         ...
         targetDiv.textContent="";
            ...
            for(let element of matched)
              ...
              clone.addEventListener("mouseover",(e)=>{ //console.log("mouse over");
                    ...
                    timeout = setTimeout(()=>{ window.Community.$ui.contextMenus[0].buildContextMenuWhenVisible(clone,e);}, 1000);
         ...
         function makeButton()
          ...
          let modes=["All","Dead","Alive","Zombie"]
           ...
           // console.log("seetings",settings);
             ...
             let button=window.Community.$ui.addAndBuildMenuButton(menuText="Sort for dead elements",null,
   ...
   function discoveriesListen()
  {
   ...
   let discoveriesButton= document.querySelector(".sidebar-discoveries");
    ...
    window.addEventListener('load', async () => {
        ...
        console.log("window:", window.Community);
